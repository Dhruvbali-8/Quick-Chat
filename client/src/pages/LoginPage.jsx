...
const LoginPage = () => {
  ...
  const { login } = useContext(AuthContext); // ✅ lowercase
      ...
      >
        ...
        {currState === "Sign Up" && !isDataSubmit && (
          <input
            ...
            className="p-2 border border-gray-500 rounded-md text-sm focus:outline-none"
            required
          />
        )}
        ...
        {!isDataSubmit && (
          <>
            <input
              ...
              required
              className="p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 text-sm"
            />
            <input
              ...
              required
              className="p-2 border border-gray-500 text-sm rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
            />
          </>
        )}
